...
- **The real unit is millimetres.** Serious skate sizing is based on the actual length of your foot in millimetres (the [Mondopoint system](https://en.wikipedia.org/wiki/Shoe_size#Mondopoint) used across the industry). Once you know your foot length in mm, you can match it to any brand precisely.
...
1. **Trace your foot.** Stand on the paper with your weight evenly distributed and trace around your foot, keeping the pencil vertical.
2. **Measure heel to longest toe.** Your longest toe isn't always your big toe. Measure the straight-line distance in millimetres.
3. **Measure both feet and use the larger one.** Almost everyone has one foot slightly bigger — size to it.
4. **Add a few millimetres of wiggle room.** For a performance fit, measure tight; for recreation, add 3–5 mm.
...
[Inline skates](/product-category/inline-skates) demand the most precise fit because the boot is stiff and your foot can't shift. Aim for a snug, contact fit: toes brushing the end when standing upright, with a sliver of clearance once your knees bend into skating position.
...
New to the discipline? Our [inline skates vs roller skates](/blog/inline-skates-vs-roller-skates) comparison explains which style suits your goals before you size up.

---

## Quad (Roller) Skate Sizing

[Quad roller skates](/product-category/roller-skates) generally fit closer to your true shoe size than inline skates, but it still varies by brand. Women's quad skates from Moxi, Riedell, Chaya, Impala, and Rio Roller usually track women's US shoe sizing, though boot width and height vary by model.

Because quad boots come in low-cut artistic styles and high-top derby styles, the same number can feel different across models — the [best roller skates for women](/blog/roller-skates-for-women) guide breaks down popular fits if you're shopping that category.
...
- **Use adjustable skates for growing feet.** Many [kids' skates](/product-category/children-products) extend three or four full sizes with a push-button mechanism, giving you room to grow safely.
- **Re-check the fit each season.** Toes touching the front mean it's time to size up.

Pair any kids' skate with proper [protective gear](/product-category/protection-gear-and-apparel) — a certified helmet is non-negotiable. [Parachute Canada](https://parachute.ca/en/injury-topic/helmets/) recommends a helmet for all wheeled sports, every session.

---

## Hockey & Ice Skate Sizing

[Hockey skates](/product-category/ice-skates) run the smallest of all — typically **1.5 to 2 US sizes below your shoe size** — because the fit needs to be performance-tight with no heel lift at all. A US size 9 shoe usually lands around a size 7–7.5 hockey skate. Most hockey boots are also heat-mouldable, so a precise initial size pays off after baking.
...
1. **Snug beats roomy.** Skate boots pack out a little with use. A skate that feels *just* snug new will feel perfect in two weeks.
2. **Wear skate socks, not gym socks.** Thin, wicking socks give the truest fit and prevent blisters.
3. **Check heel lock first.** Lace up, bend your knees, and lift your heel — if it slides up, the skate is too big regardless of toe room.
4. **Mind the width, not just the length.** Pressure on the sides of your foot means you need a wider last, not a longer skate.
5. **When stuck between sizes, size up half and adjust.** Thicker socks or a heat-mould close the gap; a too-small skate can't be fixed.

Still unsure? Our [Toronto skate shop](/blog/skate-shop-toronto) team has fitted thousands of Canadian skaters — [ask an expert](/contact) and we'll confirm your size before you order.
...
Ready to find your number? [Use our free Roller Skate Size Calculator](/roller-skates-size-calculator) for an instant brand-specific recommendation, then shop [inline skates](/product-category/inline-skates) or [roller skates](/product-category/roller-skates) in your exact size — shipped right across Canada from our Toronto warehouse.

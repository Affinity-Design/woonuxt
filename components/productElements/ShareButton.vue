...
// Root-layer override of woonuxt_base ShareButton: identical markup, but the
// Pinterest URL tolerates products without a featured image (image can be null
// in WPGraphQL data, which crashed the base component's computed).

  ...
  <footer class="bg-white order-last">
    ...
    >
      ...
      <div class="w-3/7 lg:w-auto">
        ...
        <div class="text-sm">
          <NuxtLink to="/product-category/inline-skates" class="py-1.5 block">{{
            "Inline Skates"
          }}</NuxtLink>
          <NuxtLink to="/product-category/roller-skates" class="py-1.5 block">{{
            "Roller Skates"
          }}</NuxtLink>
          <NuxtLink
            to="/product-category/replacement-parts"
            class="py-1.5 block"
      ...
      <div class="w-3/7 lg:w-auto">
        ...
        <div class="text-sm">
          ...
          <NuxtLink to="/terms" class="py-1.5 block"

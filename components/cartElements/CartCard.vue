    ...
    <div v-if="productType" class="flex items-start gap-2 group py-2">
      ...
      <div class="flex-1 min-w-0 flex flex-col">
        <div class="flex flex-wrap gap-x-2 gap-y-1 items-start text-sm">
          ...
          <NuxtLink
            class="leading-tight line-clamp-2 break-words"
            :to="productSlug"
          >
            {{ productType.name }}
          </NuxtLink>
      ...
      <div
        class="flex-shrink-0 inline-flex gap-2 flex-col items-end min-w-[80px]"
      >
        <QuantityInput :item />
        <div
        ...
        >
          <button
            ...
            class="mr-2 pr-2 border-r whitespace-nowrap"
